...
import { Clock, DollarSign, FileText, HelpCircle, CheckSquare, List } from "lucide-react";
...
const ServicePage: React.FC = () => {
  ...
  const { data: service, isLoading, error } = useGetCategoricServiceById(Number(serviceId));
    ...
    <div className="bg-face m-0 p-3 sm:p-6  rounded-2xl shadow-sm overflow-auto">
      <div className="max-w-5xl m-auto p-0 flex flex-col gap-6 sm:gap-8">
        ...
        <div className="bg-face m-0 p-0 border border-border rounded-lg overflow-hidden">
          <div className="bg-back m-0 p-4 sm:p-6 border-b border-border text-left font-semibold text-xl text-text">
