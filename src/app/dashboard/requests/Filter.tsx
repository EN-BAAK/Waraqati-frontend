...
import { DashboardAvailableRequestsFilterProps } from '@/types/components'
import { Category, REQUESTS_STATE } from '@/types/global'
import React from 'react'

const Filter: React.FC<DashboardAvailableRequestsFilterProps> = ({ search, setSearch, setCategory, setState }) => {
