...
import { FiUsers, FiBriefcase, FiGrid, FiLayers, FiHelpCircle, FiFilePlus, FiClipboard } from "react-icons/fi";
...
export const ClientSidebarLinks: SidebarLink[] = [
  ...
  { label: "Requests", href: "/client/requests", Icon: FiClipboard }
];
